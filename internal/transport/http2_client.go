...
// IsHostRewriteLiteralNonEmpty returns true if there is a non-empty host rewrite literal
// set with SetHostRewriteLiteral
...
// GetHostRewriteLiteral returns the value set in the ctx the SetHostRewriteLiteral
